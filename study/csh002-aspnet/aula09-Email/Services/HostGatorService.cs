...
public class HostGatorService : IEmailService
{
    private readonly HostGatorSettings _emailSettings;

    public HostGatorService(IOptions<HostGatorSettings> emailSettings)
    {
